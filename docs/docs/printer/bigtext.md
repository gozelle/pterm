...
<p align="center"><a href="https://github.com/gozelle/pterm/blob/master/_examples/bigtext/main.go" target="_blank">(Show source of demo)</a></p>
...
| Option                                                                                      | Type                                                         |
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Letters](https://pkg.go.dev/github.com/gozelle/pterm#BigTextPrinter.WithLetters)             | [Letters](https://pkg.go.dev/github.com/gozelle/pterm#Letters) |
| [BigCharacters](https://pkg.go.dev/github.com/gozelle/pterm#BigTextPrinter.WithBigCharacters) | map[string]string                                            |
